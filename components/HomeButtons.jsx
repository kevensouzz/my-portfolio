...
export default function HomeButtons() {
  return (
    <motion.div variants={fadeIn("up", 0.3)} initial="hidden" animate="show" exit="hidden" className={`w-full max-w-[60%] max-md:max-w-[100%] max-md:h-[90px] max-sm:h-[82.5px] flex items-center justify-between max-md:flex-col`}>
