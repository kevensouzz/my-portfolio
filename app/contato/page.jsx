      ...
      <div className={`container mx-auto py-32 text-center xl:text-left flex items-center justify-center h-full`}>
        <div className={`flex flex-col w-full max-w-[700px] max-lg:max-w-[500px] gap-3`}>
          ...
          <form method="POST" onSubmit={sendEmail} className={`flex-1 flex flex-col gap-6 w-full mx-auto z-10 max-[320px]:gap-3`}>
            ...
            <motion.input variants={fadeIn("up", 0.2)} initial="hidden" animate="show" exit="hidden" type="text" placeholder="Assunto" aria-label="Assunto" required className="input" maxLength={48} onChange={(e) => setSubject(e.target.value)} value={subject} />
